...
import com.infoandroid.weatherpoc.restCall.GenericRequestTask;
import com.infoandroid.weatherpoc.restCall.ParseResult;
import com.infoandroid.weatherpoc.restCall.TaskOutput;
import com.infoandroid.weatherpoc.utils.Constants;
import com.infoandroid.weatherpoc.utils.Event;
import com.infoandroid.weatherpoc.utils.Shared_Preferance_utility;
import com.infoandroid.weatherpoc.utils.UnitConvertor;
...
public class MainActivity extends AppCompatActivity
    ...
    private static final long NO_UPDATE_REQUIRED_THRESHOLD = 3000 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EventBus.getDefault().postSticky(new Event.Producat(longTermWeather, 1));
                Intent intent = new Intent(MainActivity.this, ListForecastActivity.class);
                startActivity(intent);
            }
        });
        ...
        loginUseName = (TextView)header.findViewById(R.id.UseName);
    ...
    private void updateMenuTitles() {
        ...
        if (Shared_Preferance_utility.getPreferences(MainActivity.this,"userName").equals("")){
    ...
    public void onResume() {
        ...
        if (Shared_Preferance_utility.getPreferences(MainActivity.this,"userName").equals("")){
            loginUseName.setText("Guset user");
            imageView.setImageDrawable(getDrawable(R.drawable.com_facebook_profile_picture_blank_portrait));
        }else {
            loginUseName.setText(Shared_Preferance_utility.getPreferences(MainActivity.this,"userName"));
           String url = Shared_Preferance_utility.getPreferences(MainActivity.this,"userimageUrl");
